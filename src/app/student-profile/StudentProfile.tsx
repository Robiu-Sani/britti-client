...
export default function StudentProfile() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/3">
              <div className="aspect-square bg-white/50 rounded-lg animate-pulse shadow-md"></div>
            ...
            <div className="w-full md:w-2/3 space-y-4">
              <div className="h-8 bg-white/50 rounded animate-pulse w-1/2"></div>
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="h-4 bg-white/50 rounded animate-pulse"
                ></div>
              ))}
            </div>
          </div>
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-r from-emerald-50 to-teal-100 flex items-center justify-center p-6">
        <div className="max-w-md w-full p-4 bg-white/80 rounded-lg shadow-md text-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-emerald-50 to-teal-100 p-6">
      <div className="max-w-4xl mx-auto bg-white/80 rounded-xl shadow-lg overflow-hidden backdrop-blur-sm">
        <div className="flex flex-col md:flex-row gap-8 p-6">
          {/* Left Column - Profile Image and Basic Info */}
          <div className="w-full md:w-1/3">
            <div className="relative aspect-square rounded-lg overflow-hidden border-2 border-white shadow-md">
              <Image
                src={user.image}
                alt={user.name}
                fill
            ...
            <div className="mt-6 space-y-4 p-4 bg-white/50 rounded-lg shadow-sm">
              <div className="flex items-center gap-2">
                <UserIcon className="text-teal-600" size={18} />
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              {/* Contact Information */}
              <div className="space-y-4 p-4 bg-white/50 rounded-lg shadow-sm">
                <h2 className="text-lg font-semibold flex items-center gap-2 text-teal-700">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Smartphone className="text-teal-600" size={16} />
              ...
              <div className="space-y-4 p-4 bg-white/50 rounded-lg shadow-sm">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Cake className="text-teal-600" size={16} />
                    <span>DOB: {formatDate(user.dateOfBirth)}</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <UserIcon className="text-teal-600" size={16} />
